...
investoday-api chain/pro-relation --method POST --body-json '{"productCode":"P0007786","productName":"红茶","pageNum":1}'
```
...
investoday-api chain/pro-ind-maps --method POST --body-json '{"stockCodes":["000001","600519"]}'
```
